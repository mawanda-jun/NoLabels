...
class VectorCapsNet:
    ...
    def build(self):
        self.summary_list = []
        self.conv = layers.Conv2D(filters=256, kernel_size=9, strides=2,
                                  padding='valid', activation='relu', name='conv1')
        self.conv_cap1 = ConvCapsuleLayer(kernel_size=9, num_caps=4, caps_dim=16, strides=2,
                                          padding='valid', routings=3, name='conv_cap1')
