...
class Siamese(tf.keras.Model):
    ...
    def __init__(self, conf, **kwargs):
        ...
        # self.bn1 = layers.BatchNormalization(momentum=0.9, name="batch_norm_1")
        self.maxpool1 = layers.MaxPool2D(3, 2, 'same', name='MaxPool1')

        self.conv2 = layers.Conv2D(256, 5, 2, 'same', activation='relu', name='CONV2')
        # self.bn2 = layers.BatchNormalization(momentum=0.9, name="batch_norm_2")
        ...
        # self.bn3 = layers.BatchNormalization(momentum=0.9, name="batch_norm_3")
        ...
        # self.bn = layers.BatchNormalization(momentum=0.99, name='batch_norm_last')
